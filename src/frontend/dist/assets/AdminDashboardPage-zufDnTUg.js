import { c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, e as clsx, R as React2, i as invariant, a as useLangStore, j as jsxRuntimeExports, L as Link } from "./index-DzhgL1zh.js";
import { t as t$1, B as Button } from "./index-Kcs4saGQ.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-C3YREQ6T.js";
import { L as Layout, U as Users, b as ShoppingBag, c as Building2, B as Bell, a as CreditCard, d as ChevronRight } from "./Layout-Dntny8Ic.js";
...
function AdminDashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { variant: "admin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground", children: t$1("page.adminDashboard", lang) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap justify-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin/orders", "data-ocid": "admin.dashboard.orders.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-3.5 h-3.5" }),
          t$1("nav.orders", lang)
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin/users", "data-ocid": "admin.dashboard.users.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", children: [
              ...
              t$1("nav.companies", lang)
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin/offers", "data-ocid": "admin.dashboard.offers.link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3", children: [
      {
        ...
        sub: lang === "ar" ? "إضافة وتعديل وحذف المنتجات" : "Add, edit and delete products",
        to: "/admin/products",
      ...
      },
      {
        ...
        sub: lang === "ar" ? "قائمة الشركاء والمزودين" : "Partner & supplier companies",
        to: "/admin/companies",
      ...
      },
      {
        ...
        sub: lang === "ar" ? "عروض وخصومات للمستخدمين" : "Discounts & promo offers",
        to: "/admin/offers",
      ...
      },
      {
        ...
        label: lang === "ar" ? "إرسال إشعارات" : "Broadcast Notifications",
        sub: lang === "ar" ? "أرسل رسائل لمجموعات المستخدمين" : "Send messages to user segments",
        to: "/admin/broadcast",
      ...
      },
      {
        ...
        sub: lang === "ar" ? "تفعيل وإيقاف طرق الدفع" : "Enable / disable payment methods",
        to: "/admin/payment-settings",
        ocid: "admin.manage.payment_settings.card",
        color: "text-blue-400"
      }
    ].map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: card.to, "data-ocid": card.ocid, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card-elevated hover:border-primary/50 transition-smooth cursor-pointer group h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-start gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: card.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: card.sub })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-muted-foreground ml-auto opacity-0 group-hover:opacity-100 transition-smooth" })
    ] }) }) }, card.to)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [
      ...
      },
      {
        ...
        value: ((_a = MOCK_STATS.ordersByStatus.find(
          (s2) => s2.status === "InTransit"
        )) == null ? void 0 : _a.count) ?? 0,
        color: "text-yellow-400",
      ...
      },
      {
        ...
        value: ((_b = MOCK_STATS.ordersByStatus.find(
          (s2) => s2.status === "Delivered"
        )) == null ? void 0 : _b.count) ?? 0,
        color: "text-green-400",
        ocid: "admin.kpi.delivered.card"
      }
    ].map((kpi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "card-elevated",
        "data-ocid": kpi.ocid,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${kpi.color} mb-2`, children: kpi.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground", children: kpi.value }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: MOCK_STATS.ordersLast7Days, barSize: 20, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            XAxis,
            {
              dataKey: "date",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2.5", children: MOCK_STATS.ordersByStatus.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `w-2 h-2 rounded-full ${STATUS_COLORS[s2.status].replace("text-", "bg-")}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-sm ${STATUS_COLORS[s2.status]}`, children: t$1(`status.${s2.status}`, lang) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-1.5 bg-muted/30 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "h-full bg-primary/60 rounded-full",
                    style: {
                      width: `${s2.count / MOCK_STATS.totalOrders * 100}%`
                    }
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-foreground w-6 text-right", children: s2.count })
              ] })
            ]
          },
          s2.status
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "card-elevated", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-display", children: lang === "ar" ? "طرق الدفع" : "Payment Methods" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: MOCK_STATS.ordersByPaymentMethod.map((pm) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "p-3 rounded-lg bg-muted/20 text-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-foreground", children: pm.count }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: t$1(`payment.${pm.method}`, lang) })
          ]
        },
        pm.method
      )) })
